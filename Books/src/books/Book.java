...
public class Book implements Comparable<Book> {
	...
	/**
	 * From the interface Comparable, it compares the books based off the title
	 * of the book.
	 */
	@Override
	...
	/**
	 * Override toString method that display the book as title by author (year).
	 */
	@Override
	...
	/**
	 * This method reads from a something.csv file and creates a list of books
	 * from it. The file must be organized by title,author,year or the file will
	 * not be able to organize and add the book to the list.
	 * 
	 * @param file
	 *            The name of the file it will read.
	 * @return A list of books it created while reading something.csv file.
	 * @throws FileNotFoundException
	 *             If the file is not found this exception will be thrown or
	 *             catch.
	 */
